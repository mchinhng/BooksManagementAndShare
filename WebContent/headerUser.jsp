		...
		<div>
			<ul style="list-style: none; padding-top: 12px">
				<li style="float: left; margin-top: -13px"><a
					href="${pageContext.request.contextPath}/BookController?action=listBookUser"> <img alt=""
						src="https://i.pinimg.com/originals/34/6a/1f/346a1f4363e1b59f6860fdce6abc1082.jpg"
						style="width: 50px; height: 50px;">
				</a></li>
				
				<li style="float: left"><a
					href="${pageContext.request.contextPath}/BookController?action=listBookUser">List
						Books</a> &nbsp;</li>
				<li style="float: left"><a
					href="indexLogin.jsp">Profile</a> &nbsp;</li>
